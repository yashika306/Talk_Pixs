  ...
  return (
        // <SafeAreaView>
            <View style={{flex:1, display:'flex', justifyContent:'center', alignItems:'center', padding:30}}>
                ...
                <TouchableOpacity onPress={()=>signout()} style={{padding:20, marginVertical: 10,borderRadius:10, backgroundColor: "#1F6049",shadowOffset:{width:0, height:10},shadowOpacity: 0.3, shadowRadius: 10, width:"100%"}}>
